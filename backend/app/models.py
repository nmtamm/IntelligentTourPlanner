...
class Trip(Base):
    ...
    days = relationship("Day", back_populates="trip", cascade="all, delete-orphan", order_by="Day.day_number")
...
class Day(Base):
    ...
    destinations = relationship("Destination", back_populates="day", cascade="all, delete-orphan", order_by="Destination.order")
