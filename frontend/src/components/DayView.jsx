...
export function DayView({ day, onUpdate, currency, onCurrencyToggle }) {
  ...
  const addCostItem = (destinationId) => {
  ...
  const updateCostItem = (destinationId, costId, updates) => {
    const destination = day.destinations.find(d => d.id === destinationId);
    if (!destination) return;
  ...
  const removeCostItem = (destinationId, costId) => {
    const destination = day.destinations.find(d => d.id === destinationId);
